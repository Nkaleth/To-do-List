...
> In this project I will build a simple HTML list of To Do tasks using webpack and served by a webpack dev server.
...
```sh
  mkdir my-folder
  cd my-folder
  git clone git@github.com:Nkaleth/To-do-list.git
```
